...
<div class="footer content">
    <div class="footer-form-subscribe rounded-2xl max-w-[81.25%] mx-auto relative z-20 mb-[-124px]" style="background:  url({{ asset('images/bg-footer.png') }}) no-repeat center center / cover;">
        <form class="flex justify-between max-md:flex-col max-md:gap-y-5 md:items-end gap-x-10 footer-form-contact">
            <div class="text-white">
                <h3 class="mb-4 font-extrabold max-md:mb-2">Get our pro offers </h3>
    ...
    <div class="bg-[#f4f5f6]">
        <div class="footer-info max-w-[1056px] mx-auto flex justify-between max-md:pt-[150px] pt-[224px] pb-[150px] px-5">
