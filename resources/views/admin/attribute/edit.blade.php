...
@section('admin.content.more')
    ...
    <form action="{{ route('admin.store.attribute.update', $attribute->id) }}" method="POST" id="admin-edit-form">
        <div class="mt-3 tab-content" id="myTabContent">
            ...
            <button type="submit" class="mt-5 btn !bg-[#3B71FE] btn-primary" id="save">Save Attribute</button>
            @csrf
        </div>
    </form>
@endsection
