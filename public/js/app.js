...
$(document).ready(function () {
  ...
  $('#action-search').on('click', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (!response.error) {
          window.location.href = "".concat(origin, "/").concat(response.url);
        }
      }
    });
  });
  ...
  $(".tour-list").slick({
    ...
    slidesToShow: 3,
    slidesToScroll: 1,
    prevArrow: "<button class='top-prev slick-prev pull-left button-slide'>\n                <i class=\"fa-solid fa-chevron-left\"></i>\n            </button>",
    nextArrow: "<button class='top-next slick-next pull-right button-slide'>\n                <i class=\"fa-solid fa-chevron-right\"></i>\n            </button>",
    responsive: [{
      breakpoint: 1023,
      settings: {
        arrows: false,
...
/******/ 	__webpack_require__.O(undefined, ["admin/css/admin","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["admin/css/admin","css/app"], () => (__webpack_require__("./resources/less/app.less")))
/******/ 	__webpack_require__.O(undefined, ["admin/css/admin","css/app"], () => (__webpack_require__("./resources/less/admin.less")))
/******/ 	__webpack_require__.O(undefined, ["admin/css/admin","css/app"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["admin/css/admin","css/app"], () => (__webpack_require__("./resources/admin/css/admin.css")))
